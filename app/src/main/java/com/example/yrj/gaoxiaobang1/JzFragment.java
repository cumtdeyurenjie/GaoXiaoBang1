...
public class JzFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (getView()==null){
            View view =inflater.inflate(R.layout.jiangzuo,container,false);
            return view;
        }else {
            return getView();
        }
    ...
    private void initNews() {
        ...
        query.addWhereEqualTo("biaoshi","jiangzuo");
    ...
    private void initView() {
        recycler_news=getView().findViewById(R.id.recycler_view1);
